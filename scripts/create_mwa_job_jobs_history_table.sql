...
(
    ...
    CONSTRAINT jobs_history_user_fkey FOREIGN KEY (user_id)
...
-- DROP TRIGGER IF EXISTS delete_trigger ON public.jobs_history;

CREATE TRIGGER delete_trigger
    BEFORE DELETE
    ON public.jobs_history
    FOR EACH ROW
    EXECUTE PROCEDURE public.delete_notify_trigger();

-- Trigger: insert_trigger

-- DROP TRIGGER IF EXISTS insert_trigger ON public.jobs_history;

CREATE TRIGGER insert_trigger
    AFTER INSERT OR UPDATE 
    ON public.jobs_history
    FOR EACH ROW
    EXECUTE PROCEDURE public.insert_notify_trigger();
