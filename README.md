...
We originally developed to extact log data and load it into a PostgreSQL database. However, it has been developed to make it easy to ingest into other data stores such as MySQL, SQLite, MongoDB, and more. Only Postgres is supported currently, if you would like to see more data stores supported, see the contributing section below.
